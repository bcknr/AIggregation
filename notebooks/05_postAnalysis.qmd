...
sf::st_write(nn_df, "./figs/nndist.gpkg")
```
...
# Add theoretical line (L(r) = r for CSR)
theo <- data.frame(r = L_df$r, L_theo = L_df$theo)
...
fig_locl <- ggplot() +
  ...
  geom_line(data = theo, aes(x = r, y = L_theo), 
